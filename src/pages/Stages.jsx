...
const stages = [
  ...
  },
  {
    ...
    missions: [
      'Onboardings : 18 sessions menées (Lenovo ThinkPad X270, Microsoft Surface Laptop 4), réinit Windows, sessions admin + employé, BitLocker, comptes M365 + Aircall + apps internes, signature Signwell — temps réduit de 1h30 à 45 min pour un groupe de 5',
      'Offboardings : 22 sessions — récupération matériel, désactivation des accès, conversion compte Microsoft en boîte aux lettres partagée rattachée au manager',
      'Rédaction du guide Onboarding complet (17 pages), charte informatique + flyer affiché en open-space, guide des logiciels approuvés, guide anti-phishing',
      'Audit et suppression des comptes inactifs (Microsoft 365, Aircall) — anciens collaborateurs encore actifs',
      'Inventaire complet du parc informatique (type, marque, modèle, S/N, état, utilisateur) sur Excel, coordination des réparations avec WIREP',
      'Mission prioritaire Aircall (~3 semaines) : audit lignes VoIP, correction des fuseaux horaires, reconfiguration de la distribution (simultané / cascade), remaniement du SVI Ubireal (arborescence + voix off pro)',
      'Rapport statistique R Markdown / ggplot2 (taux de réponse global et par collaborateur) présenté au CEO lors des Weekly Aircall',
      'Support utilisateurs : Outlook/Teams MFA, lenteurs Windows, BitLocker, matériel audiovisuel — rédaction de 4 guides techniques transférables',
    ],
    ...
    forts: [
      ...
      'Travail transversal : collaboration CEO, CTO, DPO, managers, RH, collaborateurs',
      ...
      'Production documentaire riche : 17 pages d\'onboarding + charte + 4 guides techniques transférables',
    ],
    vigilances: [
    ...
    surprises: [
      'Présentation au CEO et aux responsables de pôles plus régulière qu\'attendu (Weekly Aircall)',
      'Confiance rapide du tuteur sur des missions sensibles (gestion accès, comptes inactifs)',
      'Diversité des interlocuteurs : du CEO au stagiaire RH, en passant par le prestataire externe (WIREP)',
      'R Markdown / ggplot2 mobilisé sur un contexte 100 % entreprise, hors cadre data académique',
    ],
    refaire: [
